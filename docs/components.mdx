...
description: All Forme React components for PDF generation - Document, Page, View, Text, Image, Table, Row, Cell, Fixed, PageBreak, Svg, QrCode, and Barcode.
---

Forme provides 12 components for building PDF documents. All components are imported from `@formepdf/react`.

```tsx
import { Document, Page, View, Text, Image, Svg, QrCode, Barcode, Table, Row, Cell, Fixed, PageBreak } from '@formepdf/react';
```
