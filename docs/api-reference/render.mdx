...
title: Render PDF
sidebarTitle: Render
description: Render PDFs from templates via the hosted API — sync and async rendering, job polling, S3 uploads, metadata, resource listing, and data extraction.
---
